...
class AppointsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'appointment_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'patient_id' => 1,
            'doctor_id' => 1,
            'appointment_date' => '2016-02-18 17:41:13',
            'created' => '2016-02-18 17:41:13',
            'modified' => '2016-02-18 17:41:13'
        ],
    ];
}
